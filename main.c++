...
int main() {
    ...
    vector<Registro> todos_los_registros;
    for (auto& vec : registros_por_hilo) {
        todos_los_registros.insert(todos_los_registros.end(), vec.begin(), vec.end());
    }

    cout << "Total de registros leídos: " << todos_los_registros.size() << endl;

    // Comprobación: imprimir la primera y la última línea de datos leídos
    if (!todos_los_registros.empty()) {
        cout << "\nPrimer registro:" << endl;
        cout << "ID: " << todos_los_registros.front().identificador
             << ", Especie: " << todos_los_registros.front().especie
             << ", Nombre: " << todos_los_registros.front().nombre << endl;

        cout << "\nÚltimo registro:" << endl;
        cout << "ID: " << todos_los_registros.back().identificador
             << ", Especie: " << todos_los_registros.back().especie
             << ", Nombre: " << todos_los_registros.back().nombre << endl;
    }
